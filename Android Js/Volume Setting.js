...
ui.layout(
    <vertical padding="16">
        <text textColor="black" textSize="16sp">媒体音量 Music Volume</text>
        <seekbar id="music"/>

        <text textColor="black" textSize="16sp">通知音量 Message Volume</text>
        <seekbar id="notification"/>

        <text textColor="black" textSize="16sp">闹钟音量 Clock Volume</text>
        <seekbar id="alarm"/>
    </vertical>
);
